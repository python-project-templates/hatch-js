...
lint-py:  ## lint python with ruff
	python -m ruff check hatch_js
	python -m ruff format --check hatch_js
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix hatch_js
	python -m ruff format hatch_js
...
test:  ## run python tests
	python -m pytest -v hatch_js/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v hatch_js/tests --cov=hatch_js --cov-report term-missing --cov-report xml
